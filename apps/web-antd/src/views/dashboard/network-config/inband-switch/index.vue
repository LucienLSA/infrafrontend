...
defineOptions({ name: 'InbandSwitch' });
...
const portTableData = ref([
  ...
  },
  {
    key: '3',
    port: '1/3',
    device: 'Web-Server-001',
    vlan: 'VLAN 301',
    ip: '192.168.21.103/24',
    status: '待配置'
  }
]);
...
const networkConfigData = ref({
  switchModel: 'Cisco Catalyst 9300',
  managementVlan: 'VLAN 99',
  businessVlan: 'VLAN 300-310',
...
const templateData = ref({
  hostname: 'inband-sw-01',
  managementIp: '192.168.99.30/24',
...
<template>
  <div style="padding: 24px;">
    ...
    <div style="margin-bottom: 24px;">
      <h1 style="font-size: 24px; font-weight: bold; margin: 0 0 8px 0;">带内交换机配置</h1>
      <p style="color: #666; margin: 0;">配置带内业务网络的交换机设备，包括端口分配、VLAN配置和网络参数设置。</p>
    </div>
        ...
        <TabPane key="network-config" tab="网络配置">
          <div style="max-width: 600px;">
            <Form :model="networkConfigData" layout="vertical">
              ...
              <FormItem label="业务VLAN">
                <Input v-model:value="networkConfigData.businessVlan" />
              </FormItem>
              <FormItem label="上行端口">
    ...
    >
      <div style="max-width: 500px;">
        <Form :model="networkConfigData" layout="vertical">
          ...
          <FormItem label="业务VLAN">
            <Input v-model:value="networkConfigData.businessVlan" readonly />
          </FormItem>
          <FormItem label="上行端口">
