...
defineOptions({ name: 'OutbandSwitch' });
...
const networkConfigData = ref({
  switchModel: 'Cisco Catalyst 2960',
  managementVlan: 'VLAN 99',
  oobVlan: 'VLAN 400-410',
  uplinkPorts: '1/13-1/16',
  downlinkPorts: '1/1-1/12',
  lacpMode: 'passive',
...
const templateData = ref({
  hostname: 'outband-sw-01',
  managementIp: '192.168.99.40/24',
...
<template>
  <div style="padding: 24px;">
    ...
    <div style="margin-bottom: 24px;">
      <h1 style="font-size: 24px; font-weight: bold; margin: 0 0 8px 0;">带外交换机配置</h1>
      <p style="color: #666; margin: 0;">配置带外管理网络的交换机设备，包括端口分配、VLAN配置和网络参数设置。</p>
    </div>
        ...
        <TabPane key="network-config" tab="网络配置">
          <div style="max-width: 600px;">
            <Form :model="networkConfigData" layout="vertical">
              ...
              <FormItem label="带外VLAN">
                <Input v-model:value="networkConfigData.oobVlan" />
              </FormItem>
              <FormItem label="上行端口">
    ...
    >
      <div style="max-width: 500px;">
        <Form :model="networkConfigData" layout="vertical">
          ...
          <FormItem label="带外VLAN">
            <Input v-model:value="networkConfigData.oobVlan" readonly />
          </FormItem>
          <FormItem label="上行端口">
